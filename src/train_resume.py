...
MODEL_SAVE_PATH = "models/final_rice_disease.h5"
RESULTS_DIR = "results"
...
def main():
    parser = argparse.ArgumentParser(description='Train or resume training model')
    parser.add_argument('--checkpoint', type=str, default=None, help='Path to checkpoint model to resume from')
    parser.add_argument('--initial_epoch', type=int, default=0, help='Initial epoch to resume from')
    parser.add_argument('--epochs', type=int, default=EPOCHS, help='Total epochs to train')
    args = parser.parse_args()

    print("="*70)
    print("RICE LEAF DISEASE DETECTION - HIGH ACCURACY MODEL")
    print("="*70)
    ...
    if args.checkpoint and os.path.exists(args.checkpoint):
        ...
        if args.checkpoint:
            print(f"Checkpoint not found: {args.checkpoint}, building new model")
        else:
    ...
    print(f"Training from epoch {initial_epoch} to {epochs_to_train}")
