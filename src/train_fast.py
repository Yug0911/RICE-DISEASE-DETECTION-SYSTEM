"""
FAST CONVERGENCE VERSION: Higher LR, less dropout, more unfrozen layers
Goal: Reach 70%+ faster
"""
import os
import numpy as np
...
BATCH_SIZE = 16
EPOCHS = 100
MODEL_PATH = "models/rice_disease_fast.h5"
RESULTS_DIR = "results"
...
print("="*70)
print("FAST CONVERGENCE VERSION")
print("="*70)

train_gen, val_gen, test_gen, class_names = load_data()
num_classes = len(class_names)

print("\nPhase 1: Train head only (30 epochs, LR=0.002)...")
...
print("\nPhase 2: Fine-tune top 100 layers (90 epochs, LR=1e-5)...")
